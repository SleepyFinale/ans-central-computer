...
#
# Usage:
#   ./scripts/diagnostics/verify_fleet_namespace.sh
#   FLEET_ROBOTS="pinky clyde" ./scripts/diagnostics/verify_fleet_namespace.sh
#   ./scripts/diagnostics/verify_fleet_namespace.sh --ros   # requires sourced ROS + workspace
