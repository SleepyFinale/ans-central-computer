...
#
# Usage:
#   ./scripts/diagnostics/start_central_debug_bag.sh pinky blinky
#   ./scripts/diagnostics/start_central_debug_bag.sh   # auto-detect from /<robot>/tf
...
if [[ ${#ROBOTS[@]} -eq 0 ]]; then
  echo "No robots detected. Pass names explicitly: ./scripts/diagnostics/start_central_debug_bag.sh pinky blinky"
  exit 1
fi
